...
@implementation UIImage (BKResize)

CGRect BKCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
...
- (void)drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
    CGRect drawRect = BKCGRectFitWithContentMode(rect, self.size, contentMode);
